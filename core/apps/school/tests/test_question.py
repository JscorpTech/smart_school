...
class ScienceTest(TestCase):
    ...
    def _create_data(self):
        return ScienceModel._create_fake()

    def setUp(self):
        self.client = APIClient()
        self.instance = self._create_data()
        self.urls = {
            "list": reverse("science-list"),
            "retrieve": reverse("science-detail", kwargs={"pk": self.instance.pk}),
            "retrieve-not-found": reverse("science-detail", kwargs={"pk": 1000}),
        }
